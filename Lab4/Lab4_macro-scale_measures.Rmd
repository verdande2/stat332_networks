...
Interesting error result. Let's explore what it's telling us... First, let's doublecheck if the graph `g` has any non-isolated vertices with an out-degree of zero:
