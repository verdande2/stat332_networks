...
sg <- igraph::graph_from_data_frame(d = links, vertices = nodes, directed = FALSE)
# TODO convert igraph to visNetwork?
```
...
sg
print_formatted_graph_summary_table(sg)
```
...
# TODO ASK JOE Which are the 5 measures from that week? Interconnectedness measures? Closeness? Betweenness? Eigen?
