...
# TODO finish shape, edge color, edge line type, node color
# Shape mapping
...
# nodes$shape <- shape_map[which(nodes$command_team)] # TODO figure this out


# Node colors (background)
# node_colors <- setNames(scales::hue_pal()(length(node_types)), node_types)
# nodes$color.background <- node_colors[which(nodes$command_team)] # TODO problem right here, subsetting by logical
...
# edges$color <- edge_colors[which(edges$command_team)] # TODO similar issue to above... wtf do I need to add which() to pull out indices, then pass it in?
