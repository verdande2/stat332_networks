...
10 nodes and over a thousand edges, but many are duplicate... I think we're on track. Now, let's see about fixing those edges...
...
```{r}
# investigating biggest carriers individually?
...
```{r}
# TODO calculate measures and throw into big pretty table, make pretty
