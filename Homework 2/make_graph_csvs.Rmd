---
title: "Making a network graph into CSV files"
...
g
plot(g) # TODO why are there so many god damn curved edges when this renders?!?!?!??
```
...
# TODO: research better way to do this, there has to be a better way to flatten a df. Google and SO didn't lead to anything promising...
for (i in 1:length(edge_pairs[[1]])) {
