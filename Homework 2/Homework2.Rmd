...
# I must say, utilizing the pipe sure does make that flow look more easily understandable and clear. Pretty nifty! Learning happened here today.

legend(
  "topright",
  title = "Vertex In-degree",
  legend = paste0(legend_labels, " nodes"), #sort(unique(scales::rescale(V(g)$degree_in, c(10, 50)))),
