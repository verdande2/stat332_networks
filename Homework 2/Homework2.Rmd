...
# also consider that in a bidirectional graph, with all nodes being completely connected, as each component is, So for A and B, we have A->B and B->A (bidirectional) so those already have 2 edges linking them, one in either direction. So what exactly is meant by two paths.... wait a second... path is a path _through_ nodes along edges.... Let's take another fresh look at this...
