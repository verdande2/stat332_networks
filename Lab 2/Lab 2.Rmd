...
plot(
  ...
  vertex.size = scales::rescale(V(gangs)$Arrests, to = c(10, 50)), # even with 0 arrests, min size is 10 so we still see vertex
  ...
  #edge.label.cex = 0.6, don't need edge label size
  ...
  rescale = TRUE # TODO look into rescale behavior
)
