...
plot(
  ...
  vertex.sizes = scales::rescale(V(gangs)$Arrests, to = c(min(V(gangs)$Arrests), max(V(gangs)$Arrests))),
  
  # - nodes appear to have a semitransparent opacity set
  vertex.color = adjustcolor(vertex_colors, alpha.f = 0.7), # VERTEX ALPHA HERE
  vertex.shape = vertex_shapes,
